...
<div id="mobile-download-container" style="display:none; margin-top:0.75rem;">
  <a href="https://bitli.pro/2KRCT_c18bc349" 
     target="_blank"
     id="mobile-download-btn"
     class="btn btn-success">
    <i class="bi bi-file-earmark-pdf"></i> Tap here to download
  </a>
</div>
...
<script type="module">
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Track Firebase count when mobile download button is tapped
    ...
    window.onTurnstileSuccess = async function(token) {
      ...
      if (isMobile) {
        // On mobile, show a real tappable link instead of window.open
        document.getElementById('mobile-download-container').style.display = 'block';
      } else {
