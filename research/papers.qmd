...
pacman::p_load(scholar, rcrossref, dplyr, stringr, htmltools, here, tidyverse, ggiraph)
```
...
g_scho_plot <- citation_data %>%
  ggplot(aes(x = as.factor(year), y = cites)) +
  ...
  theme(
    ...
    plot.caption = element_text(size = 10, color = "#BDC3C7"),
