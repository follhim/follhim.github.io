...
<!-- Turnstile widget container (invisible until challenge is needed) -->
<div id="turnstile-container" style="margin-top: 0.5rem;"></div>
...
<script>
  ...
  function onTurnstileLoad() {
    window._tsWidgetId = turnstile.render('#turnstile-container', {
      ...
      appearance:         'interaction-only', // only shows UI if human interaction required
...
<script type="module">
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const WORKER_URL = 'https://turnstile-verify.yourname.workers.dev';
