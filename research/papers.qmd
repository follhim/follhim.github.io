...
<a id="cv-download-link" 
   href="https://bitli.pro/2KRCT_c18bc349" 
   download 
   target="_blank"
   style="display:none;">
</a>
...
<script type="module">
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    window.onTurnstileSuccess = async function(token) {
      // Trigger download immediately before any async ops
      // Using hidden <a> click works better on Safari/iPhone than window.open
