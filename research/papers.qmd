...
<!-- Turnstile globals: plain script so onTurnstileLoad callback is reachable -->
<script>
...
<script type="module">
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('cv-download-trigger').addEventListener('click', async function() {
      ...
      if (!window._tsToken) {
        status.textContent = 'Please wait for verification to complete…';
        return;
      }
