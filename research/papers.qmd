...
<a href="https://bitli.pro/2KRCT_c18bc349" 
   ...
   class="btn">
  <i class="bi bi-file-earmark-pdf"></i> Click here
</a>
...
<script type="module">
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    window.onTurnstileSuccess = async function(token) {
      ...
      if (isMobile) {
        // Hide the original button, show the purple one in its place
        document.getElementById('cv-download-trigger').style.display = 'none';
        document.getElementById('mobile-download-btn').style.display = 'inline-block';
      } else {
