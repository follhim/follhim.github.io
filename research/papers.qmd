...
# Debug: Check the data structures
message("Citation data structure:")
print(str(citation_data))
message("Citation data:")
print(citation_data)

message("Publication data structure:")
print(str(publication_data))
...
message("Total citations: ", total_citations)
message("Total publications: ", total_publications)
