...
# Force data into global scope and verify
citation_data <<- citation_data
publication_data <<- publication_data

# Calculate totals with explicit access
total_citations <- sum(citation_data$cites, na.rm = TRUE)
total_publications <- sum(publication_data$publications, na.rm = TRUE)
