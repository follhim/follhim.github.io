...
<div id="turnstile-modal" style="display:none;position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.55);z-index:9999;align-items:center;justify-content:center;"><div style="background:#fff;padding:2rem 2.5rem;border-radius:0.75rem;text-align:center;box-shadow:0 8px 32px rgba(0,0,0,0.25);min-width:320px;"><p id="ts-status" style="margin:0 0 1rem;font-weight:600;font-size:1rem;">Verifying&hellip;</p><div id="turnstile-container"></div></div></div>
